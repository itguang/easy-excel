...
public final class ReflectorUtil {
    ...
    private static final Map<Class<?>, ReflectorUtil> CACHE_REFLECTOR = new ConcurrentHashMap<Class<?>,
            ReflectorUtil>();
    ...
    public static Map<Class<?>, ReflectorUtil> getCacheReflector() {
        return CACHE_REFLECTOR;
    }
